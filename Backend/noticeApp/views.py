...
def crawl():
    ...
    """
    # 융합대학
    [2, 'https://security.dongguk.edu/bbs/data/list.do?menu_idx=30', '융합보안학과']
    [2, 'https://swc.dongguk.edu/bbs/data/list.do?menu_idx=46', '사회복지상담학과']
    [2, 'https://gt.dongguk.edu/bbs/data/list.do?menu_idx=58', ' 글로벌무역학과']
    'http://mme.dongguk.edu/k3/sub5/sub1.php?tsort=51&msort=62'  # 멀미난다...
    'http://dguadpr.kr/bbs/board.php?bo_table=table31&page=2'  # 광고홍보학과 #얘는 다름
    'https://movie.dongguk.edu/bbs/board.php?bo_table=movie1_3_1'  # 영화영상 #tr>td_subject
    """

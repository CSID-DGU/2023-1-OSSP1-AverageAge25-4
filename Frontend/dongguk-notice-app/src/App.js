...
function App() {
  ...
  const notifys1=[
    ...
    , date: "5.6"},
    { id: 1, title: "[참사람사회공헌센터] 2023 전공연계  " ,link: 'https://cse.dongguk.edu/article/notice1/detail/176573?article_seq=&prt_seq=&category_cd=&searchCondition=TA.SUBJECT&searchKeyword='
    ,date: "5.6"},
    ...
    ,date: "5.6"},
    { id: 3, title: "국제학생증 ISIC 발급비 지원행사 안내" ,link: '/' ,date: "5.6"},
    { id: 4, title: "서울시설공단 시민경영참여단 모집공고" ,link: '/' ,date: "5.6"},
    { id: 5, title: "유네스코 국제무예센터 2023 제 6기 .." ,link: '/' ,date: "5.5"},
    { id: 6, title: "[5대 핵심역량 함양 프로그램] 나를 .." ,link: '/',date: "5.5"},
    { id: 7, title: "(예비군연대) 제 414차 민방위의 날 .." ,link: '/',date: "5.5"},
    { id: 8, title: "LINC3.0 만족도조사 참여하고 모바일 " ,link: '/',date: "5.4"},
    { id: 9, title: "[LINC3.0] 산학공동 기술개발과제 모집" ,link: '/',date: "5.4"}
  ...
  const notifys2=[
    ...
    ,date: "5.6"},
    { id: 3, title: "2023 - 여름학기 현장실습 참가학생 모" ,link: '/' ,date: "5.5"},
    { id: 4, title: "2023학년도 여름계절학기 서울시립대학" ,link: '/' ,date: "5.5"},
    { id: 5, title: "2023학년도 여름계절학기 건국대학교 " ,link: '/' ,date: "5.5"},
    { id: 6, title: "5월 3일 모의토익 고사장 및 성적 확인" ,link: '/' ,date: "5.5"},
    { id: 7, title: "2023학년도 여름계절학기 상명대학교 " ,link: '/',date: "5.4"},
    { id: 8, title: "2023학년도 여름계절학기 숙명여자대학" ,link: '/',date: "5.4"},
    { id: 9, title: "2023학년도 여름계절학기 경희대학교" ,link: '/',date: "5.4"}
  ...
  const notifys3=[
    ...
    ,date: "5.6"},
    { id: 3, title: "2023 강원랜드 멘토링 장학생 모집안내 " ,link: '/',date: "5.5"},
    { id: 4, title: "<2023년 제 2기 동국건학장학생 최종합" ,link: '/',date: "5.5"},
    { id: 5, title: "2023년도 특별상환유예제도 안내" ,link: '/',date: "5.5"},
    { id: 6, title: "2023 전기 파안장학문화재단 총장 추천" ,link: '/',date: "5.5"},
    { id: 7, title: "제29기 미래에셋 해외교환 장학생 선발" ,link: '/',date: "5.4"},
    { id: 8, title: "2023학년도 전기 일반대학원 신(편)입학" ,link: '/',date: "5.4"},
    { id: 9, title: "2023학년도 전기 일반대학원 신(편)입학" ,link: '/',date: "5.4"}
  ];
  
  const notifys4=[
    { id: 0, title: "2023학년도 후기 일반대학원 신(편)입학" ,link: 'https://cse.dongguk.edu/article/notice1/detail/176573?article_seq=&prt_seq=&category_cd=&searchCondition=TA.SUBJECT&searchKeyword='
    ,date: "5.6"},
    ...
    ,date: "5.5"},
    { id: 3, title: "2023학년도 전기 일반대학원 신(편)입학" ,link: '/',date: "5.5"},
    { id: 4, title: "2023학년도 전기 일반대학원 신(편)입학" ,link: '/',date: "5.5"},
    { id: 5, title: "2023학년도 전기 일반대학원 신(편)입학" ,link: '/',date: "5.5"},
    { id: 6, title: "2023학년도 전기 일반대학원 일반전형 " ,link: '/',date: "5.5"},
    { id: 7, title: "2023학년도 일반대학원 ‘스마트오션모" ,link: '/',date: "5.4"},
    { id: 8, title: "2023학년도 전기 일반대학원 신(편)입학" ,link: '/',date: "5.4"},
    { id: 9, title: "2023학년도 전기 일반대학원 신(편)입학" ,link: '/',date: "5.4"}
